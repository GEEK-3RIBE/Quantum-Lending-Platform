...
declare_id!("3mBpP1uijv3txdUW4cpJRz7p3LwyCwuLWQr3ch3WEcEv");

#[program]
pub mod my_anchor_lending {
    use super::*;
    ...
    pub fn liquidate(ctx: Context<Liquidate>, target_user: Pubkey) -> Result<()> {
        let user_account = &mut ctx.accounts.user_account;
        let _lending_pool = &mut ctx.accounts.lending_pool;
